...
```bash
# 1. Fork on GitHub: https://github.com/prasannab4362/namiwhatsapp → Fork
# 2. Clone your fork
git clone https://github.com/<your-username>/namiwhatsapp.git
cd namiwhatsapp
...
```bash
git remote add upstream https://github.com/prasannab4362/namiwhatsapp.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/prasannab4362/namiwhatsapp/issues/new?template=bug_report.yml)
