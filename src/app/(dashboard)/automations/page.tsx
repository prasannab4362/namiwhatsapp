  ...
  return (
    <div className="space-y-6">
            ...
            {TEMPLATE_ORDER.map((slug) => {
              ...
              return (
                <button
                  ...
                  className="group flex flex-col items-start rounded-xl border border-slate-200 bg-white p-4 text-left transition-colors hover:border-primary/50 hover:bg-white/80"
                >
      ...
      {automations.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-xl border border-dashed border-slate-200 bg-slate-900/40">
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10">
            <Zap className="h-6 w-6 text-primary" />
          </div>
          <p className="mt-3 text-sm font-medium text-slate-900">No automations yet</p>
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="text-slate-900">{pendingDelete?.name}</span> and its execution
...
function AutomationCard({
  ...
  return (
    <li className="rounded-xl border border-slate-200 bg-white transition-colors hover:border-slate-300">
      <div className="flex items-center gap-4 p-4">
        ...
        >
          ...
          {automation.description && (
            <p className="mt-0.5 truncate text-xs text-slate-600">{automation.description}</p>
          )}
        ...
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-md text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900 data-[popup-open]:bg-slate-100"
            >
