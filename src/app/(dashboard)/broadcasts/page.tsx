    ...
    <div className="space-y-6">
      ...
      {anySending && (
        <div
          ...
          className="broadcast-indeterminate fixed inset-x-0 top-0 z-40 h-0.5 overflow-hidden bg-slate-100"
        >
      ...
      {broadcasts.length === 0 ? (
        <div className="flex h-64 flex-col items-center justify-center rounded-xl border border-slate-200 bg-white">
          ...
          <p className="text-sm font-medium text-slate-900">No broadcasts yet</p>
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-slate-200 hover:bg-transparent">
                ...
                <TableHead className="hidden text-slate-600 md:table-cell">Template</TableHead>
                <TableHead className="hidden text-right text-slate-600 sm:table-cell">
                  Recipients
                </TableHead>
                <TableHead className="hidden text-slate-600 lg:table-cell">Delivery</TableHead>
                <TableHead className="hidden text-slate-600 lg:table-cell">Read</TableHead>
                <TableHead className="text-slate-600">Status</TableHead>
                <TableHead className="hidden text-slate-600 sm:table-cell">Date</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {broadcasts.map((broadcast) => {
                ...
                return (
                  <TableRow
                    key={broadcast.id}
                    className="cursor-pointer border-slate-200 hover:bg-slate-800/50"
                  ...
                  >
                    ...
                    <TableCell className="hidden text-right text-slate-700 tabular-nums sm:table-cell">
