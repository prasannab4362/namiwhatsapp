...
const SELECT_CLASS =
  "w-full rounded-md border border-slate-300 bg-slate-100 px-2 py-1.5 text-sm text-slate-900 focus:border-primary focus:outline-none"
    ...
    <div className="fixed inset-0 flex flex-col bg-slate-50">
      ...
      <header className="flex flex-shrink-0 items-center gap-2 border-b border-slate-200 bg-white/80 px-3 py-3 sm:gap-3 sm:px-4">
        <button
          ...
          className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900"
        ...
        <input
          ...
          className="min-w-0 flex-1 rounded-md bg-transparent px-2 py-1 text-sm font-semibold text-slate-900 placeholder:text-slate-500 focus:bg-slate-100 focus:outline-none sm:text-base"
        />
    ...
    <div className="z-10 w-full max-w-[320px] sm:w-80">
      <div className="rounded-lg border border-slate-200 border-l-4 border-l-blue-500 bg-white shadow-lg">
        ...
        >
          ...
          <ChevronDown
            className={cn("h-4 w-4 text-slate-600 transition-transform", open && "rotate-180")}
          />
        </button>
        {open && (
          <div className="space-y-3 border-t border-slate-200 px-4 py-3">
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-slate-300 bg-slate-100 px-2 py-1.5 text-sm text-slate-900 focus:border-primary focus:outline-none"
              >
    ...
    <div className="space-y-2">
      ...
      <div>
        ...
        <select
          ...
          className="w-full rounded-md border border-slate-300 bg-slate-100 px-2 py-1.5 text-sm text-slate-900 focus:outline-none"
        >
        ...
        >
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="truncate text-sm font-medium text-slate-900">{meta.label}</div>
              <div className="truncate text-[11px] text-slate-500">{previewFor(step)}</div>
            </div>
            <ChevronDown
              className={cn("h-4 w-4 text-slate-600 transition-transform", expanded && "rotate-180")}
            />
          </button>
          {expanded && (
...
function AddButton({ onPick }: { onPick: (t: AutomationStepType) => void }) {
  return (
    <div className="relative flex flex-col items-center">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger
          className="flex h-8 w-8 items-center justify-center rounded-full border-2 border-dashed border-slate-300 bg-slate-50 text-slate-600 transition-colors hover:border-primary hover:bg-primary/10 hover:text-primary data-[popup-open]:border-primary data-[popup-open]:bg-primary/20 data-[popup-open]:text-primary"
          aria-label="Add step"
        >
        ...
        <DropdownMenuContent
          align="start"
          className="max-h-80 min-w-56 overflow-y-auto border-slate-300 bg-white"
        >
          {ADDABLE_STEPS.map((t) => {
      ...
      return (
        <FieldBlock label="Message text">
          <Textarea
            ...
            className="min-h-24 bg-slate-100 text-slate-900"
          />
        </FieldBlock>
      )
    case "send_template":
        ...
        <>
          <FieldBlock label="Mode">
            <select
              ...
              className="w-full rounded-md border border-slate-300 bg-slate-100 px-2 py-1.5 text-sm text-slate-900"
            >
        ...
        <>
          ...
          <FieldBlock label="Body template (JSON)">
            <Textarea
              ...
              className="min-h-20 bg-slate-100 font-mono text-xs text-slate-900"
            />
          </FieldBlock>
        </>
      )
