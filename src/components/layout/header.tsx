...
export function Header({ onOpenSidebar }: HeaderProps) {
  ...
  return (
    <header className="flex h-14 shrink-0 items-center justify-between gap-3 border-b border-slate-200 bg-white px-4 lg:px-6">
      ...
      <DropdownMenu>
        <DropdownMenuTrigger
          className="flex items-center gap-2 rounded-md px-1 py-1 transition-colors hover:bg-slate-100/70 focus:bg-slate-100/70 focus:outline-none data-popup-open:bg-slate-100/70 sm:gap-3 sm:pl-1 sm:pr-3"
