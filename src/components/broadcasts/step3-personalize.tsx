  ...
  return (
    <div className="space-y-6">
      ...
      {placeholders.length === 0 ? (
        <div className="rounded-xl border border-slate-200 bg-slate-900/50 p-6 text-center">
        ...
        <div className="space-y-4">
          {placeholders.map((placeholder) => {
            ...
            return (
              <div
                key={placeholder}
                className="rounded-xl border border-slate-200 bg-slate-900/50 p-4"
              >
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div>
                    ...
                    >
                      <SelectTrigger className="w-full border-slate-300 bg-slate-100 text-slate-900">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent className="border-slate-300 bg-slate-100">
