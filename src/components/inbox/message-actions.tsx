  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "absolute -top-3 z-10 flex h-7 items-center gap-0.5 rounded-full border border-slate-300 bg-slate-900/95 px-1 shadow-md backdrop-blur-sm transition-opacity",
      ...
      >
        <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
          <PopoverTrigger
            className="flex h-5 w-5 items-center justify-center rounded-full text-slate-700 hover:bg-slate-700 hover:text-slate-900"
            aria-label="React"
          >
