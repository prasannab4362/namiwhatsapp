...
export function PipelineSettings({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-white border-slate-300 max-h-[85vh] overflow-y-auto">
        <DialogHeader>
          ...
          <>
            <div className="grid gap-4 py-2">
              <div className="grid gap-2">
                <Label className="text-slate-700">Pipeline Name</Label>
                <Input
                  value={name}
              ...
              <div className="grid gap-2">
                <Label className="text-slate-700">Stages</Label>
                <DndContext
                  sensors={sensors}
                ...
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    className="border-slate-300 bg-slate-100 text-sm text-slate-900"
                    onKeyDown={(e) => {
                  ...
                  <Button
                    ...
                    className="shrink-0 border-slate-300 bg-transparent text-slate-700 hover:bg-slate-100"
                  >
              ...
              <Button
                ...
                className="w-full border-slate-300 bg-transparent text-slate-700 hover:bg-slate-100"
              >
                <Plus className="mr-1 h-3 w-3" />
            ...
            <DialogFooter className="border-slate-300 bg-slate-900/50">
              <Button
                variant="destructive"
...
function SortableStageRow({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className="flex items-center gap-2 rounded-lg border border-slate-300 bg-slate-100 p-2"
    >
      <button
        type="button"
        {...attributes}
        {...listeners}
        className="cursor-grab touch-none text-slate-500 hover:text-slate-700 active:cursor-grabbing"
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute left-0 top-6 z-20 flex flex-wrap gap-1 rounded-lg border border-slate-300 bg-white p-2 shadow-lg w-36">
            {colors.map((c) => (
              <button
                key={c}
                type="button"
