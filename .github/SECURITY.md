...
- [GitHub Security Advisories](https://github.com/prasannab4362/namiwhatsapp/security/advisories/new)
  (preferred — keeps the disclosure, fix, and CVE all in one place).
- Email: `prasannamb4362@gmail.com` with `[NamiwhatsCRM security]` in the subject.
...
In scope:
- Anything in this repository (`prasannab4362/namiwhatsapp`), including webhook and auth
